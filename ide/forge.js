// Generated by tools/bundle_ide.mjs from ide/flash/an3155.js, ide/flash/dfuse.js, ide/flash/stlink.js, ide/doom-sim.js, ide/browser-build.js, ide/c-sim.js, ide/example-preview.js, ide/source-search.js, ide/clock-diagram.js, ide/window-manager.js, ide/app.js - do not edit.
(() => {
"use strict";
// ---- ide/flash/an3155.js
...
const isStLink = (dev) => STLINK_FILTERS.some((f) => f.vendorId === dev.vendorId && f.productId === dev.productId);

class StLinkError extends Error {}
...
async function browserBuild({ target = 'h743', project = 'doom', projectConfig, files, source, onLog, toolchainURL = TOOLCHAIN }) {
